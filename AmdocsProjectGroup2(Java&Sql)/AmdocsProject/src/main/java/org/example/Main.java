...
public class Main {
    String url = "jdbc:mysql://localhost:3306/bloodmanagmentsystem";
    String user = "root";
    ...
    public static void donorDashBoard(Scanner scanner) {
        final String url = "jdbc:mysql://localhost:3306/bloodmanagmentsystem";
        final String user = "root";
        final String password = "Adi@1234";
        int choice = 4;
        do {
            System.out.println(" ");
